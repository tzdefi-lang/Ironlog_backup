...
extension Color {
    ...
    static let botanicalDanger = Color("BotanicalDanger")
    static let botanicalDangerLight = Color("BotanicalDangerLight")
    static let botanicalWarning = Color("BotanicalWarning")
    static let botanicalInfo = Color("BotanicalInfo")
    static let botanicalOverlay = Color("BotanicalOverlay")
